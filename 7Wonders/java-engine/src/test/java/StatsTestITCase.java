...
public class StatsTestITCase {
    ...
    void setUp()throws Exception {
        clientSpy = Mockito.spy(client);
        ReflectionTestUtils.setField(clientController, "client", clientSpy);
    }
    ...
    void sendStatsTest() {
        ...
        // On lance 1000 parties


        verify(mSpy, times(2)).unClient();
        verify(clientController, times(1000)).sendStats(any());
