...
public abstract class CardsSet {
    ...
    //BATIMENT_COMMERCIEAU(Yellow)
    public static final Card PORT = new Card(CardIds.PORT_ID, "PORT", new Effect[]{new ScoreForCategoryEffect(1, Category.MATIERE_PREMIERE), new CoinsForCategoryEffect(1, Category.MATIERE_PREMIERE)}, new Resource[]{Resource.TISSU, Resource.MINERAI, Resource.BOIS}, Category.BATIMENT_COMMERCIAL, new int[CardIds.FORUM_ID], null);
    public static final Card PHARE = new Card(CardIds.PHARE_ID, "PHARE", new Effect[]{new ScoreForCategoryEffect(1, Category.BATIMENT_COMMERCIAL), new CoinsForCategoryEffect(1, Category.BATIMENT_COMMERCIAL)}, new Resource[]{Resource.VERRE, Resource.PIERRE}, Category.BATIMENT_COMMERCIAL, new int[]{CardIds.CARAVANSERAIL_ID}, null);
    public static final Card CHAMBRE_DE_COMMERCE = new Card(CardIds.CHAMBRE_DE_COMMERCE_ID, "CHAMBRE DE COMMERCE", new Effect[]{new ScoreForCategoryEffect(2, Category.PRODUIT_MANUFACTURE), new CoinsForCategoryEffect(2, Category.PRODUIT_MANUFACTURE)}, new Resource[]{Resource.ARGILE, Resource.ARGILE, Resource.PAPYRUS}, Category.BATIMENT_COMMERCIAL);
    ...
    public static final Card GUILDE_DES_STRATEGES = new Card(CardIds.GUILDE_DES_STRATEGES_ID, "GUILDE DES STRATEGES", new ScoreForNeighborsDefeatJetonsEffect(1), new Resource[]{Resource.MINERAI, Resource.MINERAI, Resource.PIERRE, Resource.TISSU}, Category.GUILDE);
    public static final Card GUILDE_DES_ARMATEURS = new Card(CardIds.GUILDE_DES_ARMATEURS_ID, "GUILDE DES ARMATEURS", new ScoreForCategoriesEffect(1), new Resource[]{Resource.BOIS, Resource.BOIS, Resource.BOIS, Resource.PAPYRUS, Resource.VERRE}, Category.GUILDE);
