...
public abstract class CardsSet {
    ...
    //BATIMENT_COMMERCIEAU(Yellow)
    public static final Card FORUM = new Card(CardIds.FORUM_ID, "FORUM", new Effect[]{new ChoiceAllTypeResourceEffect(false)}, new Resource[]{Resource.ARGILE, Resource.ARGILE}, Category.BATIMENT_COMMERCIAL, 0, new int[]{CardIds.COMPTOIR_EST_ID, CardIds.COMPTOIR_OUEST_ID}, new int[]{CardIds.PORT_ID});
    public static final Card CARAVANSERAIL = new Card(CardIds.CARAVANSERAIL_ID, "CARAVANSERAIL", new Effect[]{new ChoiceAllTypeResourceEffect(true)}, new Resource[]{Resource.BOIS, Resource.BOIS}, Category.BATIMENT_COMMERCIAL, 0, new int[]{CardIds.MARCHE_ID}, new int[]{CardIds.PHARE_ID});
