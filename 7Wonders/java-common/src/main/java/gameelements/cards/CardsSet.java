...
public class CardsSet {
    ...
    //BATIMENT_CIVIL(Blue)
    public final static Card AQUEDUC = new Card("AQUEDUC", new ScoreEffect(5), new Resource[]{Resource.PIERRE, Resource.PIERRE, Resource.PIERRE}, Category.BATIMENT_CIVIL, new Card[]{BAINS});
    ...
    public final static Card STATUE = new Card("STATUE", new ScoreEffect(4), new Resource[]{Resource.BOIS, Resource.PIERRE, Resource.PIERRE}, Category.BATIMENT_CIVIL, new Card[]{PRÊTEUR_SUR_GAGES});
    public final static Card TRIBUNAL = new Card("TRIBUNAL", new ScoreEffect(4), new Resource[]{Resource.ARGILE, Resource.ARGILE, Resource.TISSU}, Category.BATIMENT_CIVIL, new Card[]{SCRIPTORIUM});

    //BATIMENT_COMMERCIEAU(Yellow)
    public final static Card FORUM = new Card("FORUM", new ChoiceAllTypeResourceEffect(false), new Resource[]{Resource.ARGILE, Resource.ARGILE}, Category.BATIMENT_COMMERCIAL, new Card[]{COMPTOIR_EST, COMPTOIR_OUEST});
    public final static Card CARAVANSÉRAIL = new Card("CARAVANSÉRAIL", new ChoiceAllTypeResourceEffect(true), new Resource[]{Resource.BOIS, Resource.BOIS}, Category.BATIMENT_COMMERCIAL, new Card[]{MARCHÉ});
    ...
    //BATIMENT_SCIENTIFIQUE(Green)
    public final static Card DISPENSAIRE = new Card("DISPENSAIRE", new SymbolEffect(Symbol.COMPAS, 1), new Resource[]{Resource.MINERAI, Resource.MINERAI, Resource.VERRE}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{OFFICINE});
    public final static Card LABORATOIRE = new Card("LABORATOIRE", new SymbolEffect(Symbol.ROUAGE, 1), new Resource[]{Resource.ARGILE, Resource.ARGILE, Resource.PAPYRUS}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{ATELIER});
    public final static Card BIBLIOTHÈQUE = new Card("BIBLIOTHÈQUE", new SymbolEffect(Symbol.STELE, 1), new Resource[]{Resource.PIERRE, Resource.PIERRE, Resource.TISSU}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{SCRIPTORIUM});
    ...
    public final static Card ÉCURIES = new Card("ÉCURIES", new SymbolEffect(Symbol.BOUCLIER, 2), new Resource[]{Resource.MINERAI, Resource.ARGILE, Resource.BOIS}, Category.BATIMENT_MILITAIRE, new Card[]{OFFICINE});
    public final static Card CHAMPS_DE_TIR = new Card("CHAMPS DE TIR", new SymbolEffect(Symbol.BOUCLIER, 2), new Resource[]{Resource.BOIS, Resource.BOIS, Resource.MINERAI}, Category.BATIMENT_MILITAIRE, new Card[]{ATELIER});

    //=========================================================================AGE III=========================================================================
    //BATIMENT_CIVIL(Blue)
    public final static Card PANTHÉON = new Card("PANTHÉON", new ScoreEffect(7), new Resource[]{Resource.ARGILE, Resource.ARGILE, Resource.PIERRE, Resource.PAPYRUS, Resource.TISSU, Resource.VERRE}, Category.BATIMENT_CIVIL, new Card[]{AUTEL});
    public final static Card JARDINS = new Card("JARDINS", new ScoreEffect(5), new Resource[]{Resource.BOIS, Resource.ARGILE, Resource.ARGILE}, Category.BATIMENT_CIVIL, new Card[]{THÉÂTRE});
    ...
    public final static Card SÉNAT = new Card("SÉNAT", new ScoreEffect(8), new Resource[]{Resource.MINERAI, Resource.PIERRE, Resource.BOIS, Resource.BOIS}, Category.BATIMENT_CIVIL, new Card[]{BIBLIOTHÈQUE});

    //BATIMENT_COMMERCIEAU(Yellow)
    public final static Card PORT = new Card("PORT", new Effect[]{new ScoreForCategoryEffet(1, Category.MATIERE_PREMIERE), new CoinsForCategoryEffet(1, Category.MATIERE_PREMIERE)}, new Resource[]{Resource.TISSU, Resource.MINERAI, Resource.BOIS}, Category.BATIMENT_COMMERCIAL, new Card[]{FORUM});
    public final static Card PHARE = new Card("PHARE", new Effect[]{new ScoreForCategoryEffet(1, Category.BATIMENT_COMMERCIAL), new CoinsForCategoryEffet(1, Category.BATIMENT_COMMERCIAL)}, new Resource[]{Resource.VERRE, Resource.PIERRE}, Category.BATIMENT_COMMERCIAL, new Card[]{CARAVANSÉRAIL});
    ...
    public final static Card ARÈNE = new Card("ARÈNE", new Effect[]{new ScoreForMerveilleEffect(1), new CoinsForMerveilleEffect(3)}, new Resource[]{Resource.MINERAI, Resource.PIERRE, Resource.PIERRE}, Category.BATIMENT_COMMERCIAL, new Card[]{DISPENSAIRE});

    //BATIMENT_SCIENTIFIQUE(Green)
    public final static Card LOGE = new Card("LOGE", new SymbolEffect(Symbol.COMPAS, 1), new Resource[]{Resource.ARGILE, Resource.ARGILE, Resource.TISSU, Resource.PAPYRUS}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{DISPENSAIRE});
    public final static Card OBSERVATOIRE = new Card("OBSERVATOIRE", new SymbolEffect(Symbol.ROUAGE, 1), new Resource[]{Resource.MINERAI, Resource.MINERAI, Resource.VERRE, Resource.TISSU}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{LABORATOIRE});
    public final static Card UNIVERSITÉ = new Card("UNIVERSITÉ", new SymbolEffect(Symbol.STELE, 1), new Resource[]{Resource.BOIS, Resource.BOIS, Resource.PAPYRUS, Resource.VERRE}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{BIBLIOTHÈQUE});
    public final static Card ACADEMIE = new Card("ACADÉMIE", new SymbolEffect(Symbol.COMPAS, 1), new Resource[]{Resource.PIERRE, Resource.PIERRE, Resource.PIERRE, Resource.VERRE}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{ÉCOLE});
    public final static Card ÉTUDE = new Card("ÉTUDE", new SymbolEffect(Symbol.ROUAGE, 1), new Resource[]{Resource.BOIS, Resource.PAPYRUS, Resource.TISSU}, Category.BATIMENT_SCIENTIFIQUE, new Card[]{ÉCOLE});

    //BATIMENT_MILITAIRE(Red)
    public final static Card FORTIFICATIONS = new Card("FORTIFICATIONS", new SymbolEffect(Symbol.BOUCLIER, 3), new Resource[]{Resource.PIERRE, Resource.MINERAI, Resource.MINERAI, Resource.MINERAI}, Category.BATIMENT_MILITAIRE, new Card[]{MURAILLE});
    public final static Card CIRQUE = new Card("FORTIFICATIONS", new SymbolEffect(Symbol.BOUCLIER, 3), new Resource[]{Resource.PIERRE, Resource.PIERRE, Resource.PIERRE, Resource.MINERAI}, Category.BATIMENT_MILITAIRE, new Card[]{PLACE_D_ARMES});
    ...
    public final static Card ATELIER_DE_SIÈGE = new Card("ATELIER DE SIÈGE", new SymbolEffect(Symbol.BOUCLIER, 3), new Resource[]{Resource.BOIS, Resource.ARGILE, Resource.ARGILE, Resource.ARGILE}, Category.BATIMENT_MILITAIRE, new Card[]{LABORATOIRE});
